...
import com.talpro213.mindvalley_tamim_maaz_android_test.Fragment.GalleryFragment;
import com.talpro213.mindvalley_tamim_maaz_android_test.Fragment.LibTestingFragment;
...
public class PinBoardActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.mainFrameLayout, (new GalleryFragment()).newInstance()).commit();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.pin_board, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_gallery) {
            ...
            fragmentClass = LibTestingFragment.class;
        }
